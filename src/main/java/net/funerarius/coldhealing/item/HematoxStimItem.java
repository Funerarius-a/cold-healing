...
public class HematoxStimItem extends Item implements IStim {
    ...
    public boolean shouldAutoInject(LivingEntity entity, ItemStack stimStack) {
        ...
        if (ModConfigs.hasRemovableEffect(entity, ModConfigs.HEMATOX_REMOVE.get())) {
            return true;
        }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.coldhealing.hematox_g.tooltip"));
