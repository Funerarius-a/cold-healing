...
public class NblockStimItem extends BaseHealingItem implements IStim {
    ...
    @Override public int getItemBarColor(ItemStack stack) { return 0x0062b7; }
    @Override public String getTooltipKey() { return "tooltip.coldhealing.s9_n_block.tooltip"; }
