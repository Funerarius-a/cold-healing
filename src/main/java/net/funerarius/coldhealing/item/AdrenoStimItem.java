...
public class AdrenoStimItem extends BaseHealingItem implements IStim {

    private final float healthActivationThreshold;

    public AdrenoStimItem(Properties properties, float healthActivationThreshold) {
        super(properties);
    ...
    @Override public int getItemBarColor(ItemStack stack) { return 0x6c108e; }
    @Override public String getTooltipKey() { return "tooltip.coldhealing.adreno_neural_s3.tooltip"; }
...
// Stim Pouch Integration
    ...
    public boolean shouldAutoInject(LivingEntity entity, ItemStack stimStack) {
        ...
        return ModConfigs.hasRemovableEffect(entity, ModConfigs.ADRENO_REMOVE.get());
    }
