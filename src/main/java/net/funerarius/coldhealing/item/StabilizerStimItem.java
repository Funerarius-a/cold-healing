...
public class StabilizerStimItem extends BaseHealingItem implements IStim {
    ...
    @Override public int getItemBarColor(ItemStack stack) { return 0xb70c31; }
    @Override public String getTooltipKey() { return "tooltip.coldhealing.p_04_stabilizer.tooltip"; }
...
// Stim Pouch Integration
    ...
    public boolean shouldAutoInject(LivingEntity entity, ItemStack stimStack) {
        ...
        return ModConfigs.hasRemovableEffect(entity, ModConfigs.P04_REMOVE.get());
    }
